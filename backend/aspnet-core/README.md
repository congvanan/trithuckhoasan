...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9fcfbcdc-5112-429e-8eb9-2a0d2e28afbf
```

> `9fcfbcdc-5112-429e-8eb9-2a0d2e28afbf` is the password of the certificate, you can change it to any password you want.
