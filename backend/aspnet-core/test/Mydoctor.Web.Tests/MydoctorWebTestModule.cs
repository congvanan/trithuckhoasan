...
[DependsOn(
    ...
    typeof(MydoctorWebModule),
    typeof(MydoctorApplicationTestModule),
    typeof(MydoctorEntityFrameworkCoreTestModule)
)]
public class MydoctorWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<IMvcBuilder>(builder =>
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(MydoctorWebModule).Assembly));
        });
