...
using Mydoctor.Blazor.Server.Tiered.Components;
using Mydoctor.Blazor.Server.Tiered.Menus;
...
public class MydoctorBlazorModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddMapperlyObjectMapper<MydoctorBlazorModule>();
    }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/Mydoctor.Blazor.Server.Tiered.styles.css", true));
                }
            );
        });
    }
