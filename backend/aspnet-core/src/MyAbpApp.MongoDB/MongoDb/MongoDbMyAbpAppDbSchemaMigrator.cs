...
public class MongoDbMyAbpAppDbSchemaMigrator : IMyAbpAppDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbMyAbpAppDbSchemaMigrator(IServiceProvider serviceProvider)
    {
