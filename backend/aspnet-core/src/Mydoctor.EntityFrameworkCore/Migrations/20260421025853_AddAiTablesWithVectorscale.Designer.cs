...
{
    [DbContext(typeof(MydoctorDbContext))]
    [Migration("20260421025853_AddAiTablesWithVectorscale")]
    partial class AddAiTablesWithVectorscale
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresExtension(modelBuilder, "vectorscale");
            NpgsqlModelBuilderExtensions.UseIdentityByDefaultColumns(modelBuilder);

            modelBuilder.Entity("Mydoctor.Ai.AiChunk", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Embedding"), "diskann");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("Embedding"), new[] { "vector_cosine_ops" });

                    b.HasIndex("SourceId");

                    b.ToTable("AppAiChunks", (string)null);
                });

            modelBuilder.Entity("Mydoctor.Ai.AiConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAiConversations", (string)null);
                });

            modelBuilder.Entity("Mydoctor.Ai.AiDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAiDocuments", (string)null);
                });

            modelBuilder.Entity("Mydoctor.Ai.AiFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAiFeedbacks", (string)null);
                });

            modelBuilder.Entity("Mydoctor.Ai.AiIngestionJob", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("ProcessedDocumentCount")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppAiIngestionJobs", (string)null);
                });

            modelBuilder.Entity("Mydoctor.Ai.AiMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAiMessages", (string)null);
                });

            modelBuilder.Entity("Mydoctor.Ai.AiSource", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAiSources", (string)null);
                });
            ...
            modelBuilder.Entity("Mydoctor.Ai.AiMessage", b =>
                {
                    b.HasOne("Mydoctor.Ai.AiConversation", null)
                        .WithMany("Messages")
