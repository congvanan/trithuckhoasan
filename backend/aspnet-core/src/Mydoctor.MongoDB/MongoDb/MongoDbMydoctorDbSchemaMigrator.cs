...
public class MongoDbMydoctorDbSchemaMigrator : IMydoctorDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbMydoctorDbSchemaMigrator(IServiceProvider serviceProvider)
    {
