...
using MyAbpApp.Blazor.Server.Tiered.Components;
using MyAbpApp.Blazor.Server.Tiered.Menus;
...
public class MyAbpAppBlazorModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddMapperlyObjectMapper<MyAbpAppBlazorModule>();
    }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/MyAbpApp.Blazor.Server.Tiered.styles.css", true));
                }
            );
        });
    }
