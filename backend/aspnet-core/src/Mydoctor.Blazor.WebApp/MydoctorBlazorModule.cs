...
using Mydoctor.Blazor.WebApp.Client;
using Mydoctor.Blazor.WebApp.Client.Menus;
using Mydoctor.Blazor.WebApp.Components;
...
public class MydoctorBlazorModule : AbpModule
{
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/Mydoctor.Blazor.WebApp.Client.styles.css", true));
                }
            );
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new MydoctorMenuContributor(context.Services.GetConfiguration()));
        });
    }
