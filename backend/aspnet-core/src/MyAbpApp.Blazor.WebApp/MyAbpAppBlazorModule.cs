...
using MyAbpApp.Blazor.WebApp.Client;
using MyAbpApp.Blazor.WebApp.Client.Menus;
using MyAbpApp.Blazor.WebApp.Components;
...
public class MyAbpAppBlazorModule : AbpModule
{
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/MyAbpApp.Blazor.WebApp.Client.styles.css", true));
                }
            );
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new MyAbpAppMenuContributor(context.Services.GetConfiguration()));
        });
    }
